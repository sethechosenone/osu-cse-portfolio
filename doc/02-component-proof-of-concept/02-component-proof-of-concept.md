...
I'm going with the mutable comparator priority queue because it adds another layer of versatility to the data structure, and is very simple to implement. It's low hanging fruit that
